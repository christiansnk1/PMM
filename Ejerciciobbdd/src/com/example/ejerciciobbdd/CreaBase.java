	...
	public void onCreate(SQLiteDatabase db)
	{
		// TODO Auto-generated method stub
		 db.execSQL("CREATE TABLE centros (" +
	        ...
	        db.execSQL("INSERT INTO centros VALUES (10,'S','IES cabañal','Avda. Los cabañal 25', '965-887654',538)");
	        db.execSQL("INSERT INTO centros VALUES (15,'P','IES serpis', 'C/serpis','985-112322',250)");
	        db.execSQL("INSERT INTO centros VALUES (22,'S', 'IES europa', 'C/Mina 45','925-443400',300)");
	        db.execSQL("INSERT INTO centros VALUES (45,'P', 'CP rich', 'C/Granada 5','926-202310',220)");
	        db.execSQL("INSERT INTO centros VALUES (50,'S', 'IES pepe ', 'C/Los Toreros 21','989-406090',310)");
	        ...
	        db.execSQL("INSERT INTO personal VALUES (10,4480099, 'Perez Perez, Manuel','ADMINISTRATIVO', 1800.00)");
	        db.execSQL("INSERT INTO personal VALUES (15,1002345, 'Muñoz Lopez, Fernando', 'ADMINISTRATIVO', 1800.00)");
	        db.execSQL("INSERT INTO personal VALUES (15,7002660, 'Rubio Moreno, Laura', 'ADMINISTRATIVO', 1800.00)");
	        db.execSQL("INSERT INTO personal VALUES (22,5502678, 'Marín Tintin, Martin', 'ADMINISTRATIVO', 1800.00)");
	        db.execSQL("INSERT INTO personal VALUES (22,6600980, 'Perez Gil, Elena','CONSERJE', 1750.00)");
